...
import static uffrlib.math.MathUtil.sigFigRounding;
...
public class RBMKFuelRod implements InfoProvider, Hashable, Serializable, Cloneable
{
	...
	public void addInformation(List<String> info)
	{
		...
		info.add("Depletion: " + sigFigRounding((remainingYield / data.yield()) * 100, 5, 0) + '%');
	...
	{
		return remainingYield / data.yield();
	}
